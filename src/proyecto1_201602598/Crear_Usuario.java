...
public class Crear_Usuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtid.setColumns(12);
        getContentPane().add(txtid, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 50, -1, -1));

        txtnombre.setColumns(12);
        getContentPane().add(txtnombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 80, -1, -1));

        txtuser.setColumns(12);
        getContentPane().add(txtuser, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 140, -1, -1));

        txtapellido.setColumns(12);
        getContentPane().add(txtapellido, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 110, -1, -1));

        txtpass.setColumns(12);
        getContentPane().add(txtpass, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 240, -1, -1));

        txtcpass.setColumns(12);
        getContentPane().add(txtcpass, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 240, -1, 20));
        ...
        getContentPane().add(lblfondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 320, 330));
